...
router.get("/settings/global", protect, adminMiddleware, getIDCardSettings);
router.put("/settings/global", protect, adminMiddleware, updateIDCardSettings);

router.get("/sources/delivery-agents", protect, adminMiddleware, getDeliveryAgentsForIDCards);
router.get("/driver/:agentId", protect, adminMiddleware, getDriverIDCard);
